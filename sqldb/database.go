...
func Setup(guildId string, channelId string, emoji string, amount int) (bool, error) {
...
func GetArchiveEmoji(guildId string) (string, error) {
...
func SetArchiveEmoji(guildId string, emote string) error {
	parsed, err := strconv.ParseInt(guildId, 10, 0)
	if err != nil {
		return err
	}
...
func SetCustomCount(guildId string, channelId string, amount int) error {
